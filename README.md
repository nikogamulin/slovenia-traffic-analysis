...
├── data/                   # Traffic datasets (834MB)
│   ├── production_merged_vehicle_count.csv
│   ├── production_merged_vehicle_speed.csv
│   ├── weather_enhanced_traffic.csv
│   ├── enhanced_traffic_features.csv
